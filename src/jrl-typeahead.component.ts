import { Component, Input, Output, EventEmitter, ViewChild, forwardRef, TemplateRef } from '@angular/core';
...
export const TYPEAHEAD_CONTROL_VALUE_ACCESSOR:any = {
  ...
  useExisting: forwardRef(() => JrlTypeahead),
  multi: true
};
...
export class JrlTypeahead implements ControlValueAccessor {

  /**
   * Optional Template to show permanently at the bottom underneath
   */
  @Input() bottomTemplate: TemplateRef<any>;

  /**
   * The Template to show in the TypeAhead Result for each Suggestion
   */
