...
exports.TYPEAHEAD_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: core_1.forwardRef(function () { return JrlTypeahead; }),
    multi: true
};
var JrlTypeahead = (function () {
    function JrlTypeahead() {
        /**
    ...
    Object.defineProperty(JrlTypeahead.prototype, "value", {
        /**
         * Get accessor.
         */
        get: function () {
     ...
     */
    JrlTypeahead.prototype.writeValue = function (value) {
     ...
     * From ControlValueAccessor interface.
     */
    JrlTypeahead.prototype.registerOnChange = function (fn) {
        this.onChangeCallback = fn;
    };
    /**
     * From ControlValueAccessor interface.
     */
    JrlTypeahead.prototype.registerOnTouched = function (fn) {
     ...
     * @param isDisabled
     */
    JrlTypeahead.prototype.setDisabledState = function (isDisabled) {
        this.isDisabled = isDisabled;
    };
    /**
     * Called when a keydown event is fired on the input element.
     */
    JrlTypeahead.prototype.inputKeyDown = function (event) {
     ...
     */
    JrlTypeahead.prototype.setActiveSuggestion = function (suggestion) {
     ...
     */
    JrlTypeahead.prototype.getActiveSuggestionIndex = function () {
     ...
     */
    JrlTypeahead.prototype.indexOfObject = function (array, property, value) {
     ...
     */
    JrlTypeahead.prototype.inputKeyUp = function (event) {
     ...
     */
    JrlTypeahead.prototype.inputFocus = function (event) {
     ...
     */
    JrlTypeahead.prototype.inputBlur = function (event) {
        this.typeahead = '';
        this.areSuggestionsVisible = false;
     ...
     */
    JrlTypeahead.prototype.populateTypeahead = function () {
     ...
     */
    JrlTypeahead.prototype.selectSuggestion = function (suggestion) {
        // Set the variable
     ...
     */
    JrlTypeahead.prototype.blurInputElement = function () {
     ...
     */
    JrlTypeahead.prototype.hasSelection = function () {
...
exports.JrlTypeahead = JrlTypeahead;
//# sourceMappingURL=jrl-typeahead.component.js.map